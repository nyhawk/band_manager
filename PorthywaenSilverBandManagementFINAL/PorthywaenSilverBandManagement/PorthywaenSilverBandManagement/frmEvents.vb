...
Public Class frmEvents
	...
	Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
		...
		MsgBox("Event deleted", vbInformation, "Events")
...
Saving and viewing availibility
 ...
 - You can view the players available for an event by selecting the event in the table and clicking 'View available players'.", vbInformation, "Events")
	End Sub
End Class